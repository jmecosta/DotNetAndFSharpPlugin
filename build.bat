...
msbuild BuildPlugins.msbuild /p:VisualStudioVersion=12.0 /p:AssemblyPatcherTaskOn=true /p:EndVSQFile=AnalysisPlugin2013.VSQ /p:SkipCopy=No  > buildlog2013.txt

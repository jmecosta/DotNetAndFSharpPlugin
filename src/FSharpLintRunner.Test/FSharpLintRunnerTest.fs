...
type SonarRules() = 
    ...
    member test.``Analyses Correctly Code`` () =
        ...
        rule.Params.Add(new RuleParam(Key = "Lines", DefaultValue = "10" ))
        ...
        rule.Params.Add(new RuleParam(Key = "MaxLinesInModule", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInProperty", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInRecord", DefaultValue = "2" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInValue", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInLambdaFunction", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInMatchLambdaFunction", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInFunction", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInEnum", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInClass", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInConstructor", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInMember", DefaultValue = "1" ))
        rule.Params.Add(new RuleParam(Key = "MaxLinesInUnion", DefaultValue = "1" ))
        profile.AddRule(rule)
